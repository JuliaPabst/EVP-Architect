...
describe('ProjectPage', () => {
  ...
  describe('Project ID Display', () => {
    ...
    it('should display different project IDs correctly', () => {
      ...
      expect(screen.getByText('Project: another-project-456')).toBeInTheDocument();
    });
    ...
    it('should handle project IDs with special characters', () => {
      ...
      expect(screen.getByText('Project: project_test-123.v2')).toBeInTheDocument();
    });
  });
  ...
  describe('Content Display', () => {
    it('should display project description text', () => {
      ...
      expect(
        screen.getByText('This is the project page. Project details will be displayed here.'),
      ).toBeInTheDocument();
    });
  ...
  describe('Layout Structure', () => {
    ...
    it('should have header before main content', () => {
      ...
      expect((elements[0] as Element).getAttribute('data-testid')).toBe('header');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle project IDs with spaces', () => {
      ...
      expect(screen.getByText('Project: project with spaces')).toBeInTheDocument();
    });
